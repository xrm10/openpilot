...
class SettingsLayout(NavScroller):
  def __init__(self):
    ...
    maps_btn = SettingsBigButton("maps", "", gui_app.texture("icons_mici/settings.png", 64, 64))
    maps_btn.set_click_callback(lambda: gui_app.push_widget(NavigationLayoutMici()))

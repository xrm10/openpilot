...
def dmonitoringd_thread():
  ...
  DM = DriverMonitoring(
    ...
    xrm10_dm_comfort_profile=params.get("Xrm10DmComfortProfile", return_default=True),
  )
  demo_mode=False
  ...
  while True:
    ...
    if sm['driverStateV2'].frameId % 40 == 1:
      ...
      DM.set_xrm10_dm_comfort_profile(params.get("Xrm10DmComfortProfile", return_default=True))

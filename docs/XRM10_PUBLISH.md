...
If replacing the branch base, preserve a backup branch first and then use:

```powershell
& 'C:\Users\Hp\AppData\Local\GitHubDesktop\app-3.5.12\resources\app\git\cmd\git.exe' push --force-with-lease xrm10 dev
```

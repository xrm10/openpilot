...
def sp_stats(end_event):
  ...
  param_keys = [
    ...
    'DriverMonitoringSensitivity',
    'TorqueResponseProfile',
    ...
    'Xrm10StopYieldAdvisory',
    'Xrm10RoundaboutAdvisory',
    'Xrm10MergeAdvisory',
    'Xrm10CrossTrafficAdvisory',
    'Xrm10LaneSuggestionAdvisory',
    'Xrm10FasterLaneSuggestion',
    'Xrm10CurveSlowdownAdvisory',
    'Xrm10ZoneCautionAdvisory',
    'Xrm10LeadCarMovedAdvisory',
    'Xrm10ExperimentalEventRecorder',
    'Xrm10ReplayLogging',
    'Xrm10PlannerNextAction',
    'Xrm10PlannerActionDistance',
    'Xrm10PlannerConfidence',
    'Xrm10PlannerReason',
    'Xrm10VoiceAssistantEnabled',
    'Xrm10VoiceAssistantName',
    'Xrm10VoiceAssistantMode',
    'Xrm10VoiceAssistantProvider',
    'Xrm10VoiceAssistantWakeWordEnabled',
    'Xrm10VoiceAssistantReadAloud',
    'Xrm10VoiceAssistantWakeSound',
    'Xrm10VoiceAssistantShortReplies',
    'Xrm10VoiceAssistantOnroadQna',
    'Xrm10VoiceAssistantStatus',
    'Xrm10VoiceAssistantBridgeStatus',
    'Xrm10VoiceAssistantWakeWordDetectedAt',
    'Xrm10VoiceAssistantLastSpokenAt',
    'Xrm10VoiceAssistantUpdatedAt',
    'Xrm10NavSyncRequested',
    'Xrm10CodexReviewLoop',
    'Xrm10CodexAutoDecode',
    'Xrm10CodexPackageStatus',
    'Xrm10SmartAppStatus',
    'Xrm10SmartScore',
    'Xrm10SmartGate',

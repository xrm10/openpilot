...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"Xrm10DmComfortProfile", {PERSISTENT | BACKUP, INT, "0"}},
    {"Xrm10DriveHealth", {CLEAR_ON_MANAGER_START, JSON}},
    {"Xrm10DriveHealthStatus", {CLEAR_ON_MANAGER_START, STRING, "waiting for live data"}},
    {"Xrm10EventHistory", {CLEAR_ON_MANAGER_START, JSON}},
    {"Xrm10EventHistoryStatus", {CLEAR_ON_MANAGER_START, STRING, "no recent events"}},
    {"Xrm10LoggingStatus", {CLEAR_ON_MANAGER_START, STRING, "standard upload behavior"}},
    {"Xrm10MapQuality", {CLEAR_ON_MANAGER_START, JSON}},
    {"Xrm10MapQualityStatus", {CLEAR_ON_MANAGER_START, STRING, "map quality not checked yet"}},
    {"Xrm10PerformanceProfile", {PERSISTENT | BACKUP, INT, "1"}},
    {"Xrm10PerformanceProfileApplied", {PERSISTENT, INT, "1"}},
    {"Xrm10ReplayTestMode", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"Xrm10RemoteLoggingMode", {PERSISTENT | BACKUP, INT, "1"}},
    {"Xrm10RouteConfidence", {CLEAR_ON_MANAGER_START, JSON}},
    {"Xrm10RouteConfidenceStatus", {CLEAR_ON_MANAGER_START, STRING, "route not detected"}},
    {"Xrm10SettingsSnapshot", {PERSISTENT | BACKUP, JSON}},
    {"Xrm10SnapshotCommand", {PERSISTENT | BACKUP, INT, "0"}},
    {"Xrm10SnapshotStatus", {PERSISTENT, STRING, "no snapshot saved"}},
    {"Xrm10TorqueTuning", {CLEAR_ON_MANAGER_START, JSON}},
    {"Xrm10TorqueTuningStatus", {CLEAR_ON_MANAGER_START, STRING, "collecting steering data"}},
